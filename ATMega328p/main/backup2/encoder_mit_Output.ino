...
void setup() {
  ...
  calibrationValue_1 = 281.19; // uncomment this if you want to set this value in the sketch
  calibrationValue_2 = 275.55; // uncomment this if you want to set this value in the sketch
